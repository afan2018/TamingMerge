...
Inductive exp : Set :=  (*r expressions *)
 ...
 | e_rcd (l:i) (A:typ) (e:exp) (*r record *)
...
Fixpoint open_exp_wrt_exp_rec (k:nat) (e_5:exp) (e__6:exp) {struct e__6}: exp :=
  ...
  | (e_rcd l A e) => e_rcd l A (open_exp_wrt_exp_rec k e_5 e)
...
Inductive lc_exp : exp -> Prop :=    (* defn lc_exp *)
 ...
 | lc_e_anno : forall (e:exp) (A:typ),
     (lc_exp e) ->
     (lc_exp (e_anno e A))
 | lc_e_rcd : forall (l:i) (A:typ) (e:exp),
     (lc_exp e) ->
     (lc_exp (e_rcd l A e))
...
Fixpoint subst_exp (e_5:exp) (x5:var) (e__6:exp) {struct e__6} : exp :=
  ...
  | (e_rcd l A e) => e_rcd l A (subst_exp e_5 x5 e)
...
Inductive value : exp -> Prop :=    (* defn value *)
 ...
 | value_merge : forall (v1 v2:exp),
     ...
     value v2 ->
     value (e_merge v1 v2)
 | value_rcd : forall (l:i) (A:typ) (e:exp),
     lc_exp e ->
     value (e_rcd l A e).
...
Inductive TypedReduce : exp -> typ -> exp -> Prop :=    (* defn TypedReduce *)
 ...
 | TReduce_rcd : forall (l:i) (A:typ) (e:exp) (B:typ),
     lc_exp e ->
     ord B ->
      not ( topLike B )  ->
     sub A B ->
...
with papp : exp -> vl -> exp -> Prop :=    (* defn papp *)
 | Papp_abs : forall (A:typ) (e:exp) (B:typ) (e':exp),
     lc_exp (e_abs A e B) ->
     lc_exp e' ->
     papp (e_abs A e B) (vl_exp e') (e_anno  (  (open_exp_wrt_exp  e (e_anno e' A) )  )  B)
 | Papp_proj : forall (l:i) (A:typ) (e:exp),
     lc_exp e ->
     papp (e_rcd l A e) (vl_la l) (e_anno e A)
 | Papp_etop : forall (e:exp),
     lc_exp e ->
     papp e_top (vl_exp e) e_top
 | Papp_ltop : forall (l:i),
     papp e_top (vl_la l) e_top
 | Papp_emerge : forall (v1 v2 e e1 e2:exp),
     papp v1 (vl_exp e) e1 ->
     papp v2 (vl_exp e) e2 ->
     papp (e_merge v1 v2) (vl_exp e) (e_merge e1 e2)
 | Papp_lmerge : forall (v1 v2:exp) (l:i) (e1 e2:exp),
     papp v1 (vl_la l) e1 ->
     papp v2 (vl_la l) e2 ->
     papp (e_merge v1 v2) (vl_la l) (e_merge e1 e2)
with step : exp -> exp -> Prop :=    (* defn step *)
 | Step_papp : forall (v1 e2 e:exp),
     value v1 ->
     papp v1 (vl_exp e2) e ->
     step (e_app v1 e2) e
...
Inductive pType : exp -> typ -> Prop :=    (* defn pType *)
 ...
 | PT_rcd : forall (l:i) (A:typ) (u:exp),
     lc_exp u ->
     pType (e_rcd l A u) (t_rcd l A)
...
Inductive Typing : ctx -> exp -> dirflag -> typ -> Prop :=    (* defn Typing *)
 ...
 | Typ_rcd : forall (G:ctx) (l:i) (A:typ) (e:exp),
     Typing G e Chk A ->
     Typing G (e_rcd l A e) Inf (t_rcd l A)
